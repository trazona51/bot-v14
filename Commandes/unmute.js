...
module.exports = {
    ...
    name: "unmute",
    description: "Enlève la sourdine d'un membre du serveur Discord",
    ...
    async run(bot, message, args) {
        ...
        if(message.member.roles.highest.comparePositionTo(member.roles.highest) <= 0) return message.reply("Vous ne puvez pas unmute ce membre !")
